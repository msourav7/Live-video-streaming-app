...
//n level nesting for replies
const commentsData = [
  {
    name: "Sourav",
    text: "shbvsiudhbcuniwabyianf iuygfd ioaufhe aou hnoiuaef",
    replies: [
        {
            name: "Aniketh",
            text: "shbvsiudhbcuniwabyianf iuygfd ioaufhe aou hnoiuaef",
...
const Comment = ({ data }) => {
  ...
  return (
    <div className="flex bg-gray-100 shadow-sm p-2 w-4/6 rounded-lg my-2">
      <img
        className="w-10 h-10"
        alt="user"
...
const CommentsList = ({ comments }) => {
  //dont use keys indexes as keys
  return comments.map((comment, indexes) => (
    <div key={indexes}>
...
const CommentsContainer = () => {
  return (
    <div className="m-4 p-2">
      ...
      {/* recursion for n level of replies */}
